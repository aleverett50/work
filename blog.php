...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<a class="btn btn-default" href="<?= DOMAIN ?>/blog/<?= $blog_post->seo_url ?>"> View Full Blog Post </a>
		...
		<div class="col-md-2">
			...
			<img alt="<?= $image[0]->alt ?>" class="blog-list-image" src="<?= DOMAIN ?>/blog-images/<?= $image[0]->id ?>.<?= $image[0]->ext ?>">
